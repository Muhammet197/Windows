...
export default function App() {
  ...
  const { works, addWork, updateWork, deleteWork, lang, toggleLang,
          categories, addCategory, updateCategory, deleteCategory,
          environments, addEnvironment, updateEnvironment, deleteEnvironment } = store
  ...
  return (
    <div className="flex min-h-screen bg-slate-100">
      ...
      <div className="flex-1 md:ml-56 pb-20 md:pb-0">
        ...
        <AnimatePresence>
          {detailWork && (
            <div className="fixed inset-0 md:left-56 bg-slate-100 z-30 overflow-y-auto">
              <WorkDetail
                work={detailWork}
                lang={lang}
                categories={categories}
        ...
        {page === 'works' && (
          <div className="max-w-6xl mx-auto px-4 py-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-xl font-bold text-slate-900">{t.navWorks}</h1>
